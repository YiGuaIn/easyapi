...
let file = rootDir + '/utils/util.js'
let name = rootDir + '/templates/default.tpl'
let sidebarTpl = rootDir + '/templates/sidebar.tpl'
let contentTpl = rootDir + '/templates/parag.tpl'
